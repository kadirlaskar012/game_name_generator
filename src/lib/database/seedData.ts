...
export interface SeedStyle {
  ...
  configuration: {
    ...
    casing?: 'uppercase' | 'lowercase' | 'preserve';
...
export interface SeedSymbol {
  ...
  symbol: string;
  category: string;
  position: 'prefix' | 'suffix' | 'both' | 'enclosed';
  isActive: boolean;
}
...
export const SEED_TEMPLATES: SeedTemplate[] = [
  { id: '44444444-4444-4444-4444-444444444401', template: '亗{name}亗', isActive: true },
  { id: '44444444-4444-4444-4444-444444444402', template: '『{name}』メ', isActive: true },
  { id: '44444444-4444-4444-4444-444444444403', template: '꧁༺{name}༻꧂', isActive: true },
  { id: '44444444-4444-4444-4444-444444444404', template: '么{name}么', isActive: true },
  { id: '44444444-4444-4444-4444-444444444405', template: '{name}々', isActive: true },
  { id: '44444444-4444-4444-4444-444444444406', template: '【{name}】〆', isActive: true },
  { id: '44444444-4444-4444-4444-444444444407', template: '乂{name}乂', isActive: true },
  { id: '44444444-4444-4444-4444-444444444408', template: '𓊈{name}𓊉', isActive: true },
  { id: '44444444-4444-4444-4444-444444444409', template: '神{name}神', isActive: true },
  { id: '44444444-4444-4444-4444-444444444410', template: '👑{name}👑', isActive: true },
  { id: '44444444-4444-4444-4444-444444444411', template: '☠{name}☠', isActive: true },
  { id: '44444444-4444-4444-4444-444444444412', template: '⚡{name}⚡', isActive: true },
  { id: '44444444-4444-4444-4444-444444444413', template: '✿{name}✿', isActive: true },
  { id: '44444444-4444-4444-4444-444444444414', template: '• {name} •', isActive: true },
  { id: '44444444-4444-4444-4444-444444444415', template: '× {name} ×', isActive: true },
];

export const SEED_SEO_PAGES: SeedSeoPage[] = [
  {
...
export const SEED_BLOCKED_WORDS: string[] = [
  'fuck', 'shit', 'bitch', 'asshole', 'cunt', 'dick', 'nigger', 'nigga', 'faggot',
  'whore', 'slut', 'pussy', 'bastard', 'hitler', 'nazi', 'pedophile', 'rape',
  'suicide', 'terrorist', 'retard', 'cock', 'porn'
];
