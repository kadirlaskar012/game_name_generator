import { w as deleteSymbol, x as getAllSymbolsAdmin, y as saveSymbol } from '../../../chunks/repository_CQmdAj9R.mjs';
import { e as adminSymbolSchema } from '../../../chunks/schemas_B1KCwizN.mjs';
...
const POST = async ({ request }) => {
  ...
  try {
    ...
    const saved = await saveSymbol(parse.data);
