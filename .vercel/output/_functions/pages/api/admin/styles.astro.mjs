import { q as deleteStyle, t as getAllStylesAdmin, v as saveStyle } from '../../../chunks/repository_CQmdAj9R.mjs';
import { d as adminStyleSchema } from '../../../chunks/schemas_B1KCwizN.mjs';
...
const POST = async ({ request }) => {
  ...
  try {
    ...
    const saved = await saveStyle(parse.data);
